...
Отсюда рабочая версия: сервер или его сеть периодически перестают
принимать соединения целиком, а телефон был просто тем, с чего заход
случался чаще. Проверяется скриптом выше в момент отказа.
